...
import { ACTION_STATS_FETCH_STATS, REQUEST_TYPE_STATS } from '../../../lib/constants';
import HttpClient from '../../../lib/httpClient';
import { notifyFetchBegin } from './fetchBegin';
import { notifyFetchDone } from './fetchDone';

export const notifyFetchStats = payload => createAction(ACTION_STATS_FETCH_STATS, payload);
